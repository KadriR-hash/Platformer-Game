                ...
                switch (line.charAt(j)) {
                    ...
                    case '2':
                       ...
                       // Node coin = createEntity(j*60, i*60, 60, 60, Color.GOLD);
                        ...
                        break;
                    case '3':
                    	image = new Image("/platformerproject/finishmark.png");//it works	
         ...
         {//still there is a small problem with timer
             ...
             for (int j = 0; j < line.length(); j++) {
                 switch (line.charAt(j)) {
 					...
 					Image image;
 					try {
 						image = new Image(new FileInputStream(/*"C:\\Users\\SBS\\eclipse-workspace\\platformerproject\\src\\platform.jpg"*/System.getProperty("user.dir")+"\\platform.jpg"));//it works
