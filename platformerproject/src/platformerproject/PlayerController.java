    	 ...
    	 if(haswon) 
    	 {
    		 ...
    		 //FILE SYSTEM
     		 ...
     		 try {		
						...
						dStorage = (DataStorage) ois.readObject();

						
						int scoretocompare = dStorage.lvltopscore;
						ois.close();
						...
						if(player.score>scoretocompare) {
							FileOutputStream fosf = new FileOutputStream("save.dat");
							BufferedOutputStream bosf = new BufferedOutputStream(fosf);
							ObjectOutputStream oosf = new ObjectOutputStream(bosf);
							
							topscore=player.score;
							System.out.println(" SCORE FOR THIS LEVEL IS "+topscore);
							dStorage.lvltopscore = topscore;							
							oosf.writeObject(dStorage);
